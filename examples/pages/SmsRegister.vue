    ...
    >
      <div
        ...
        slot-scope="{
          ...
          isProcessing,
          formSubmitHandle,
          verifyCodeSendHandle,
          verifyCodeForm,
          verifyCodeCanBeSend,
          verifyCodeTotalTimer,
          verifyCodeIsProcessing
        }"
        v-cloak
      >
        ...
        >
          ...
          <div class="form-field mb-4">
            <input
              ...
              v-model="form.phone"
              :class="{
                'bg-red-100 border-red-300 focus:border-red-300':
                  form.errors.has('phone') || verifyCodeForm.errors.has('phone')
              }"
            />
            <div
              v-if="
              ...
              v-text="
                form.errors.first('phone') ||
                  verifyCodeForm.errors.first('phone')
              "
              class="form-field-error -mb-4 text-left text-xs text-red-500 truncate"
            ></div>
          </div>
          <div class="form-field mb-4">
            <div
              class="flex items-center justify-center items-center border border-gray-300"
            >
              <input
                type="text"
                name="verify_code"
