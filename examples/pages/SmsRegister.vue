<template>
  <div class="flex justify-center items-center flex-1">
    <validate-form-logic
      ...
      ref="validateLogic"
    >
      <div class="p-8 border rounded bg-white"
        ...
        <form class="mt-2 text-gray-900"
          ...
          <div class="form-field mb-4">
            <div class="flex items-center justify-center items-center border border-gray-300">
              ...
              <progress-button type="button"
                ...
                <span v-text="verifyCodeTotalTimer"></span>秒后重新获取</progress-button>
            </div>
          ...
          <div class="form-field mb-2">
            <select v-model="form.source"
              ...
              <option v-for="source in sources" value="source" v-text="source"></option>
            </select>
            <div v-if="form.errors.has('source')"
          ...
          <div class="form-button pt-2">
            <progress-button type="submit"
              ...
              :processing="isProcessing">提交</progress-button>
          </div>
        </form>
      </div>
    </validate-form-logic>
