<template>
    <div class="flex justify-center items-center flex-1">
        <validate-sms :request_type_id="1"
                      request_name="测试"
                      @sms-register-fail="smsRegisterFail"
                      @sms-register-successful="smsRegisterSuccessful"
                      @sms-verify-code-sent-successful="verifyCodeSentSuccessful"
                      @verify-code-sent-fail="verifyCodeSentFail">
            <div slot-scope="{ form, isProcessing, formSubmitHandle, verifyCodeSendHandle, verifyCodeForm, verifyCodeCanBeSend, verifyCodeTotalTimer, verifyCodeIsProcessing }" v-cloak>
